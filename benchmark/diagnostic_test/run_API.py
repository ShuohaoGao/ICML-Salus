...
# 其他固定参数
config = {
    "class_doctor": "Doctor_1Agent",  # 实现医生agent的class
    # "class_doctor": "DoctorAgent_Diagnosis_Decision_Action",
    "class_doctor": "DoctorAgent_Diagnosis_Verify_Decision_Action",
    "patient": "deepseek-v4-flash",  # 病人扮演
    "scenario_num": "10000",  # 即全部病历
    "parallel": "90",  # 并行测试，取决于doctor LLM的并发限制
    "cnt_repeat": "1",  # 重复次数
    "date": "0424",  # version
}
